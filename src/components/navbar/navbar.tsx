...
const navbarItemsSelected = "text-highlight";
const navbarItemsSelectedOnHover = "hover:text-highlight";
...
const Header = () => {
  ...
  return (
    <div className="z-[9999] w-full h-30 sticky">
      <div className="container mx-auto px-4 h-full">
        <div className="flex justify-between items-center h-full text-base">
          <Link href="/" className="flex flex-row">
            <Image src={"/favicon.ico"} alt="Logo" width={42} height={1} />
            <Heading
              size="text-xl"
